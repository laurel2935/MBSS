 ...
 */
public class myTRP extends AbstractBeliefPropagation {
  ...
  public myTRP (TreeFactory f)
  {
    this (f, null);
  }

  public myTRP (TerminationCondition cond)
  {
    this (null, cond);
  }

  public myTRP (TreeFactory f, TerminationCondition cond)
  {
    factory = f;
    terminator = cond;
  }

  public static myTRP createForMaxProduct ()
  {
    myTRP trp = new myTRP ();
  ...
  public myTRP setTerminator (TerminationCondition cond)
  {
    terminator = cond;
    return this;
  }

  public myTRP setFactory (TreeFactory factory)
  {
...
//        }
  ...
  static public interface TerminationCondition extends Cloneable, Serializable {
    ...
    //  will still work.
    public boolean shouldContinue (myTRP trp);
