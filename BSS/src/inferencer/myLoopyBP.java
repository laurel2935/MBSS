 ...
 */
public class myLoopyBP extends AbstractBeliefPropagation {
  ...
  // Note this does not have the sophisticated Terminator interface
	...
	public myLoopyBP () { this (new AbstractBeliefPropagation.SumProductMessageStrategy (), DEFAULT_MAX_ITER); }

	public myLoopyBP (int maxIter) { this (new AbstractBeliefPropagation.SumProductMessageStrategy (), maxIter); }

  public myLoopyBP (AbstractBeliefPropagation.MessageStrategy messager, int maxIter)
  {
    super (messager);
  ...
  {
    return new myLoopyBP (new MaxProductMessageStrategy (), DEFAULT_MAX_ITER);
  }

  public myLoopyBP setRand (Random rand)
  {
    this.rand = rand;
    return this;
  }
