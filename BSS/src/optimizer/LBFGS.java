//this file comes from ParallelMLR (e.g., LBFGS.java & Mcsrch.java)
//This tool train a regularized Multiclass Logistic Regression
//for large number of classes
//{cf. Distributed Training of Large-scale Logistic models}
...
public class LBFGS
{
	...
	{
		private static final long serialVersionUID = -3703520400905556763L;
		public int iflag;
	...
	public static double gtol = 1e-3;
	...
	private Mcsrch m_lineSearcher;
	
	private double[] solution_cache = null;
	...
	/** This subroutine solves the unconstrained minimization problem
	  ...
	  *
	  * p-5 gradient w.r.t. the function
	  ...
	  *
	  * p-6 whether should we calculate the diagonal matrix by ourselves
	  ...
	  *
	  * p-9 expected precision w.r.t. line search routine
	...
	public void lbfgs ( int n , int m , double[] x , double f , double[] g , boolean diagco , double[] diag , int[] iprint , double eps , double xtol , int[] iflag ) throws ExceptionWithIflag
	{
		...
		while ( true )
		{
			...
			m_lineSearcher.mcsrch ( n , x , f , g , w , ispt + point * n , stp , ftol , xtol , maxfev , info , nfev , diag );
